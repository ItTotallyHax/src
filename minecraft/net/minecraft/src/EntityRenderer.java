...
public class EntityRenderer
{
    ...
    public float debugCamYaw = 0.0F;
    public float prevDebugCamYaw = 0.0F;
    public float debugCamPitch = 0.0F;
    public float prevDebugCamPitch = 0.0F;
    ...
    private void renderHand(float par1, int par2)
    {
        if (this.debugViewDirection <= 0)
        {
            ...
            AxiomHook.postBobbingHook(par1);
            ...
            if (this.mc.gameSettings.thirdPersonView == 0 && !this.mc.renderViewEntity.isPlayerSleeping() && !this.mc.gameSettings.hideGUI && !this.mc.playerController.func_78747_a())
            {
                ...
                if (AxiomHook.renderHandItemHook())
                {
    ...
    private void updateLightmap()
    {
        ...
        if (var1 != null)
        {
            for (int var2 = 0; var2 < 256; ++var2)
            {
                ...
                float var8 = var5 * ((var5 * 0.6F + 0.4F) * 0.6F + 0.4F);
                float var9 = var5 * (var5 * var5 * 0.6F + 0.4F);
                float var10 = var6 + var5;
                float var11 = var7 + var8;
                float var12 = var4 + var9;
                var10 = var10 * 0.96F + 0.03F;
                var11 = var11 * 0.96F + 0.03F;
                var12 = var12 * 0.96F + 0.03F;

                if (var1.provider.worldType == 1)
                {
                    var10 = 0.22F + var5 * 0.75F;
                    var11 = 0.28F + var8 * 0.75F;
                    var12 = 0.25F + var9 * 0.75F;
                }

                float var13 = this.mc.gameSettings.gammaSetting;
                var13 = AxiomHook.gammaSetHook(var13);
                ...
                var10 = var10 * (1.0F - var13) + var14 * var13;
                var11 = var11 * (1.0F - var13) + var15 * var13;
                var12 = var12 * (1.0F - var13) + var16 * var13;
                var10 = var10 * 0.96F + 0.03F;
                var11 = var11 * 0.96F + 0.03F;
                var12 = var12 * 0.96F + 0.03F;
                ...
                short var17 = 255;
                int var18 = (int)(var10 * 255.0F);
                int var19 = (int)(var11 * 255.0F);
                int var20 = (int)(var12 * 255.0F);
                this.lightmapColors[var2] = var17 << 24 | var18 << 16 | var19 << 8 | var20;
            }
    ...
    public void renderWorld(float par1, long par2)
    {
        ...
        for (int var13 = 0; var13 < 2; ++var13)
        {
            ...
            AxiomHook.globalRenderHook(par1);
    ...
    private void updateFogColor(float par1)
    {
        ...
        if (this.mc.gameSettings.renderDistance < 2)
        {
            Vec3 var11 = MathHelper.sin(var2.getCelestialAngleRadians(par1)) > 0.0F ? Vec3.getVec3Pool().getVecFromPool(-1.0D, 0.0D, 0.0D) : Vec3.getVec3Pool().getVecFromPool(1.0D, 0.0D, 0.0D);
        ...
        if (this.cloudFog)
        {
            Vec3 var14 = var2.drawClouds(par1);
