...
public class PlayerControllerMP
{
    ...
    {
        AxiomHook.playerClickBlockHook(par1, par2, par3, par4);
    ...
    {
        this.blockHitDelay = AxiomHook.blockHitDelaySetHook(this.blockHitDelay);
        ...
        else if (par1 == this.currentBlockX && par2 == this.currentBlockY && par3 == this.currentblockZ)
        {
            int var5 = this.mc.theWorld.getBlockId(par1, par2, par3);
            ...
            this.curBlockDamageMP += AxiomHook.curBlockDamageSetHook(var6, par1, par2, par3, this.curBlockDamageMP);
