...
import net.axiom.gui.screens.AxiomGuiAltSwitch;
...
public class GuiMainMenu extends GuiScreen
{
    ...
    public void initGui()
    {
        ...
        if (this.mc.isDemo())
        {
            this.func_73972_b(var3, 24, var2);
        }
        else
        {
            this.func_73969_a(var3, 24, var2);
        }

        this.controlList.add(new GuiButton(3, this.width / 2 - 100, var3 + 48, var2.translateKey("menu.mods")));
    ...
    {
        this.controlList.add(new GuiButton(1, this.width / 2 - 100, par1, "Alt Accounts"));
    ...
    protected void actionPerformed(GuiButton par1GuiButton)
    {
        ...
        {
            this.mc.displayGuiScreen(new AxiomGuiAltSwitch(this));
        }
    ...
    public void drawScreen(int par1, int par2, float par3)
    {
        ...
        GL11.glPopMatrix();
        String var9 = "Axiom v" + AxiomSetup.version;
