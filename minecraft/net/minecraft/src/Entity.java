...
public abstract class Entity
{
    ...
    public void setDead()
    {
        AxiomHook.playerDeathHook(this);
        this.isDead = true;
    }
    ...
    public void onEntityUpdate()
    {
        ...
        if (this.isSprinting() && !this.isInWater())
        {
            ...
            int var3 = MathHelper.floor_double(this.posY - 0.20000000298023224D - (double)this.yOffset);
            var1 = MathHelper.floor_double(this.posZ);
            int var4 = this.worldObj.getBlockId(var2, var3, var1);
        ...
        if (this.handleWaterMovement())
        {
            if (!this.inWater && !this.firstUpdate)
            {
                ...
                for (var1 = 0; (float)var1 < 1.0F + this.width * 20.0F; ++var1)
                {
                    var5 = (this.rand.nextFloat() * 2.0F - 1.0F) * this.width;
                    var8 = (this.rand.nextFloat() * 2.0F - 1.0F) * this.width;
                    this.worldObj.spawnParticle("bubble", this.posX + (double)var5, (double)(var7 + 1.0F), this.posZ + (double)var8, this.motionX, this.motionY - (double)(this.rand.nextFloat() * 0.2F), this.motionZ);
                }
                ...
                for (var1 = 0; (float)var1 < 1.0F + this.width * 20.0F; ++var1)
                {
                    var5 = (this.rand.nextFloat() * 2.0F - 1.0F) * this.width;
                    var8 = (this.rand.nextFloat() * 2.0F - 1.0F) * this.width;
                    this.worldObj.spawnParticle("splash", this.posX + (double)var5, (double)(var7 + 1.0F), this.posZ + (double)var8, this.motionX, this.motionY, this.motionZ);
                }
            }
    ...
    public void moveEntity(double par1, double par3, double par5)
    {
        ...
        else
        {
            ...
            for (Iterator var21 = var35.iterator(); var21.hasNext(); par3 = var20.calculateYOffset(this.boundingBox, par3))
            {
                var20 = (AxisAlignedBB)var21.next();
            }
            ...
            for (var23 = var35.iterator(); var23.hasNext(); par1 = var22.calculateXOffset(this.boundingBox, par1))
            {
            ...
            for (var23 = var35.iterator(); var23.hasNext(); par5 = var22.calculateZOffset(this.boundingBox, par5))
            {
                var22 = (AxisAlignedBB)var23.next();
            }
            ...
            if (this.stepHeight > 0.0F && var36 && (var18 || this.ySize < 0.05F) && (var11 != par1 || var15 != par5))
            {
                ...
                for (var32 = var35.iterator(); var32.hasNext(); par3 = var31.calculateYOffset(this.boundingBox, par3))
                {
                    var31 = (AxisAlignedBB)var32.next();
                }
                ...
                for (var32 = var35.iterator(); var32.hasNext(); par1 = var31.calculateXOffset(this.boundingBox, par1))
                {
                    var31 = (AxisAlignedBB)var32.next();
                }
                ...
                for (var32 = var35.iterator(); var32.hasNext(); par5 = var31.calculateZOffset(this.boundingBox, par5))
                {
                    var31 = (AxisAlignedBB)var32.next();
                }
                ...
                if (var26 * var26 + var28 * var28 >= par1 * par1 + par5 * par5)
                {
                    par1 = var26;
                    par3 = var24;
                    par5 = var28;
                ...
                {
                    double var33 = this.boundingBox.minY - (double)((int)this.boundingBox.minY);

                    if (var33 > 0.0D)
                    {
                        this.ySize = (float)((double)this.ySize + var33 + 0.01D);
                    }
                }
            }
            ...
            var24 = this.posZ - var9;

            if (this.canTriggerWalking() && !var18 && this.ridingEntity == null)
            {
                this.distanceWalkedModified = (float)((double)this.distanceWalkedModified + (double)MathHelper.sqrt_double(var26 * var26 + var24 * var24) * 0.6D);
                int var38 = MathHelper.floor_double(this.posX);
                int var29 = MathHelper.floor_double(this.posY - 0.20000000298023224D - (double)this.yOffset);
                int var39 = MathHelper.floor_double(this.posZ);
                int var40 = this.worldObj.getBlockId(var38, var29, var39);

                if (var40 == 0 && this.worldObj.getBlockId(var38, var29 - 1, var39) == Block.fence.blockID)
                {
                    var40 = this.worldObj.getBlockId(var38, var29 - 1, var39);
                }

                if (this.distanceWalkedModified > (float)this.nextStepDistance && var40 > 0)
                {
                    this.nextStepDistance = (int)this.distanceWalkedModified + 1;
                    this.playStepSound(var38, var29, var39, var40);
                    Block.blocksList[var40].onEntityWalking(this.worldObj, var38, var29, var39, this);
                }
            }

            this.doBlockCollisions();
            boolean var37 = this.isWet();
    ...
    {
        double var2 = par1Entity.posX;
        double var4 = par1Entity.boundingBox.minY + (double)par1Entity.height;
