...
public class RenderGlobal implements IWorldAccess
{
    ...
    public void loadRenderers()
    {
        if (this.theWorld != null)
        {
            ...
            {
                WorldRenderer[] var3 = this.worldRenderers;
                var1 = var3.length;
            ...
            int var8 = 64 << 3 - this.renderDistance;
            ...
            this.renderChunksWide = var8 / 16 + 1;
            this.renderChunksTall = 16;
            this.renderChunksDeep = var8 / 16 + 1;
            ...
            for (Iterator var5 = this.worldRenderersToUpdate.iterator(); var5.hasNext(); var4.needsUpdate = false)
            {
                var4 = (WorldRenderer)var5.next();
            }
            ...
            {
                for (int var6 = 0; var6 < this.renderChunksTall; ++var6)
                {
                    for (int var7 = 0; var7 < this.renderChunksDeep; ++var7)
                    {
                        this.worldRenderers[(var7 * this.renderChunksTall + var6) * this.renderChunksWide + var9] = new WorldRenderer(this.theWorld, this.tileEntities, var9 * 16, var6 * 16, var7 * 16, this.glRenderListBase + var1);

                        if (this.occlusionEnabled)
                        {
                            this.worldRenderers[(var7 * this.renderChunksTall + var6) * this.renderChunksWide + var9].glOcclusionQuery = this.glOcclusionQueryBase.get(var2);
                        }

                        this.worldRenderers[(var7 * this.renderChunksTall + var6) * this.renderChunksWide + var9].isWaitingOnOcclusionQuery = false;
                        this.worldRenderers[(var7 * this.renderChunksTall + var6) * this.renderChunksWide + var9].isVisible = true;
                        this.worldRenderers[(var7 * this.renderChunksTall + var6) * this.renderChunksWide + var9].isInFrustum = true;
                        this.worldRenderers[(var7 * this.renderChunksTall + var6) * this.renderChunksWide + var9].chunkIndex = var2++;
                        this.worldRenderers[(var7 * this.renderChunksTall + var6) * this.renderChunksWide + var9].markDirty();
                        this.sortedWorldRenderers[(var7 * this.renderChunksTall + var6) * this.renderChunksWide + var9] = this.worldRenderers[(var7 * this.renderChunksTall + var6) * this.renderChunksWide + var9];
                        this.worldRenderersToUpdate.add(this.worldRenderers[(var7 * this.renderChunksTall + var6) * this.renderChunksWide + var9]);
                        var1 += 3;
                    }
                }
            }
    ...
    public void renderEntities(Vec3 par1Vec3, ICamera par2ICamera, float par3)
    {
        ...
        else
        {
            ...
            for (var6 = 0; var6 < var5.size(); ++var6)
            {
                ...
                if (AxiomHook.onEntityRender(var7) && var7.isInRangeToRenderVec3D(par1Vec3) && (var7.ignoreFrustumCheck || par2ICamera.isBoundingBoxInFrustum(var7.boundingBox)) && (var7 != this.mc.renderViewEntity || this.mc.gameSettings.thirdPersonView != 0 || this.mc.renderViewEntity.isPlayerSleeping()) && this.theWorld.blockExists(MathHelper.floor_double(var7.posX), 0, MathHelper.floor_double(var7.posZ)))
                {
                    ++this.countEntitiesRendered;
                    RenderManager.instance.renderEntity(var7, par3);
                }
    ...
    private int renderSortedRenderers(int par1, int par2, int par3, double par4)
    {
        ...
        EntityLiving var21 = this.mc.renderViewEntity;
        double var22 = var21.lastTickPosX + (var21.posX - var21.lastTickPosX) * par4;
        double var10 = var21.lastTickPosY + (var21.posY - var21.lastTickPosY) * par4;
        double var12 = var21.lastTickPosZ + (var21.posZ - var21.lastTickPosZ) * par4;
        int var14 = 0;
        ...
        for (Iterator var19 = this.glRenderLists.iterator(); var19.hasNext(); this.allRenderLists[var17].func_78420_a(var23.getGLCallListForPass(par3)))
        {
            var23 = (WorldRenderer)var19.next();
            var17 = -1;

            for (int var20 = 0; var20 < var14; ++var20)
            {
                if (this.allRenderLists[var20].func_78418_a(var23.posXMinus, var23.posYMinus, var23.posZMinus))
                {
                    var17 = var20;
                }
            }
            ...
            {
                var17 = var14++;
                this.allRenderLists[var17].func_78422_a(var23.posXMinus, var23.posYMinus, var23.posZMinus, var22, var10, var12);
            }
        }
