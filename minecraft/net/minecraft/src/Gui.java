...
public class Gui
{
    ...
    public static void drawRect(int par0, int par1, int par2, int par3, int par4)
    {
        ...
        float var6 = (float)(par4 >> 24 & 255) / 255.0F;
        float var7 = (float)(par4 >> 16 & 255) / 255.0F;
        float var8 = (float)(par4 >> 8 & 255) / 255.0F;
        float var9 = (float)(par4 & 255) / 255.0F;
        ...
        var10.addVertex((double)par0, (double)par3, 0.0D);
        var10.addVertex((double)par2, (double)par3, 0.0D);
        var10.addVertex((double)par2, (double)par1, 0.0D);
        var10.addVertex((double)par0, (double)par1, 0.0D);
        var10.draw();
    ...
    public Gui()
    {
        AxiomHook.guiCreationHook(this);
    }
}
