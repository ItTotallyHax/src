    ...
    public FontRenderer(GameSettings par1GameSettings, String par2Str, RenderEngine par3RenderEngine, boolean par4)
    {
        ...
        while (var9 < 256)
        {
            ...
            while (true)
            {
                if (var12 >= 0)
                {
                    ...
                    for (var14 = 0; var14 < 8 && var16; ++var14)
                    {
                        var15 = (var11 * 8 + var14) * var19;
                        int var17 = var8[var13 + var15] & 255;
        ...
        for (var9 = 0; var9 < 32; ++var9)
        {
            ...
            if (par1GameSettings.anaglyph)
            {
                ...
                var14 = (var11 * 30 + var12 * 70) / 100;
                var15 = (var11 * 30 + var13 * 70) / 100;
                var11 = var20;
                var12 = var14;
                var13 = var15;
            }
