...
public class NetClientHandler extends NetHandler
{
    ...
    {
        if (AxiomHook.entityVelocityHook(par1Packet28EntityVelocity))
        {
    ...
    {
        if (AxiomHook.sendQueueAddHook(par1Packet))
        {
            if (!this.field_72554_f)
            {
                this.netManager.addToSendQueue(par1Packet);
    ...
    {
        if (AxiomHook.chatPacketHook(par1Packet3Chat))
        {
    ...
    {
        AxiomHook.mobSpawnHook(par1Packet24MobSpawn);
