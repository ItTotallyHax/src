...
public class Block
{
    ...
    {
        return AxiomHook.blockBrightnessFloatSetHook(par1IBlockAccess.getBrightness(par2, par3, par4, lightValue[par1IBlockAccess.getBlockId(par2, par3, par4)]));
    }
    ...
    {
        return AxiomHook.blockBrightnessIntegerSetHook(par1IBlockAccess.getLightBrightnessForSkyBlocks(par2, par3, par4, lightValue[par1IBlockAccess.getBlockId(par2, par3, par4)]));
    }
    ...
    {
        return AxiomHook.blockRenderPassSetHook(0, this);
    }
