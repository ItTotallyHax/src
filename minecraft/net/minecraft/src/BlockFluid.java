...
public abstract class BlockFluid extends Block
{
    ...
    {
        return AxiomHook.fluidBoundingBoxCreationHook(this, par2, par3, par4);
    }
        ...
        for (int var7 = 0; var7 < 4; ++var7)
        {
            ...
            if (var10 < 0)
            {
                if (!par1IBlockAccess.getBlockMaterial(var8, par3, var9).blocksMovement())
                {
                    ...
                    {
                        var11 = var10 - (var6 - 8);
                        var5 = var5.addVector((double)((var8 - par2) * var11), (double)((par3 - par3) * var11), (double)((var9 - par4) * var11));
                    }
                }
            }
            else if (var10 >= 0)
    ...
    public void randomDisplayTick(World par1World, int par2, int par3, int par4, Random par5Random)
    {
        ...
        if (this.blockMaterial == Material.lava && par1World.getBlockMaterial(par2, par3 + 1, par4) == Material.air && !par1World.isBlockOpaqueCube(par2, par3 + 1, par4))
        {
            if (par5Random.nextInt(100) == 0)
            {
                ...
                par1World.playSound(var21, var11, var22, "liquid.lavapop", 0.2F + par5Random.nextFloat() * 0.2F, 0.9F + par5Random.nextFloat() * 0.15F);
            }
