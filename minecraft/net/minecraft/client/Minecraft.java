...
public abstract class Minecraft implements Runnable, IPlayerUsage
{
    ...
    private void runGameLoop()
    {
        ...
        else
        {
            ...
            {
                EntityRenderer var6 = this.entityRenderer;
    ...
    {
        AxiomHook.playerClickHook(par1);
    ...
    public void runTick()
    {
        this.rightClickDelayTimer = AxiomHook.rightClickDelaySetHook(this.rightClickDelayTimer);
            ...
            while (Keyboard.next())
            {
                ...
                if (Keyboard.getEventKeyState())
                {
                    ...
                    else
                    {
                        ...
                        {
                            if (Keyboard.getEventKey() == 2 + var2)
                            {
                                this.thePlayer.inventory.currentItem = var2;
                            }
                        }
                        ...
                        if (this.gameSettings.showDebugInfo && this.gameSettings.field_74329_Q)
                        {
                            ...
                            for (var2 = 0; var2 < 9; ++var2)
                            {
                                if (Keyboard.getEventKey() == 2 + var2)
                                {
                                    this.updateDebugProfilerName(var2 + 1);
                                }
                            }
                        }
                    }
    ...
    public static void main(String[] par0ArrayOfStr)
    {
        ...
        for (int var7 = 2; var7 < par0ArrayOfStr.length; ++var7)
        {
            ...
            {
                String var10000 = par0ArrayOfStr[var7 + 1];
            }
        ...
        var9 = new MinecraftFakeLauncher(var1);
    ...
    private void clickMiddleMouseButton()
    {
        if (this.objectMouseOver != null)
        {
            ...
            if (this.objectMouseOver.typeOfHit == EnumMovingObjectType.TILE)
            {
                ...
                int var9 = var4 >= 256 ? var8.blockID : var4;
            ...
            else
            {
                ...
                {
                    var4 = Item.painting.shiftedIndex;
                }
                else if (this.objectMouseOver.entityHit instanceof EntityMinecart)
                {
                    ...
                    {
                        var4 = Item.minecartPowered.shiftedIndex;
                    }
                    else if (var10.minecartType == 1)
                    {
                        var4 = Item.minecartCrate.shiftedIndex;
                    }
                    else
                    {
                        var4 = Item.minecartEmpty.shiftedIndex;
                    }
                }
                else if (this.objectMouseOver.entityHit instanceof EntityBoat)
                {
                    var4 = Item.boat.shiftedIndex;
                }
                else
                {
                    var4 = Item.monsterPlacer.shiftedIndex;
